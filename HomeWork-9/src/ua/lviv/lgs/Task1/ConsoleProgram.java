/*
 * LOGOS IT Acedemy, First Java Core Console Application
 */
...
/* displays the application menu on the console */
	...
	public static void main(String[] args) throws WrongInputConsoleParametersException {
		...
		while (true) {
			...
			case "1": {
				...
				if (!flag) {
					String message = "You enter uncorect month";
			...
			case "10": {
				...
				if (!flag) {
					String message = "This month haven't an even number of days";
					throw new WrongInputConsoleParametersException(message);
				}
				break;
	 ...
	 */
	 ...
	 static boolean isMonthExist(Months[] arrayOfMonths, String month) {
		boolean flag = false;
